/****************************************************************************
** Meta object code from reading C++ file 'point_cloud_process.h'
**
...
#include <memory>
#include "../../../../../src/PointCloudProcess/point_cloud_process.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'point_cloud_process.h' doesn't include <QObject>."
...
void PclProcess::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (PclProcess::*)(size_t , CloudProperty , Visibility , TreeList );
...
// SIGNAL 0
void PclProcess::callVisualizeProcess(size_t _t1, CloudProperty _t2, Visibility _t3, TreeList _t4)
{
